...
export const ARRECADADO = 3738;
export const PCT = "29.90";
  ...
  return (
    <div className="flex flex-col min-h-screen">
      ...
      <div className="only-mobile" style={{
        ...
        {/* Linha inferior: WhatsApp + Compartilhar */}
        <div style={{ display:"flex", gap:"8px", marginTop:"8px" }}>
          ...
          <button
            ...
            onClick={() => {
              if (navigator.share) {
                navigator.share({ title: "Ajude Francivaldo e seus 4 filhos", text: "Um pai sozinho criando 4 filhos precisa da sua ajuda. Cada doação faz diferença!", url: window.location.href }).catch(() => {});
              } else {
                navigator.clipboard?.writeText(window.location.href);
                showToast({ message: "Link copiado para compartilhar!", type: "success" });
              }
            }}
            style={{
              flex:1,
